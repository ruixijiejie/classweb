  ...
  <div class="indexContent main">
    ...
    <ul class="number">
      <li>
        ...
        <p>12000</p>
        <a href="javascript:;void (0)">查看详情<i class="fa fa-angle-right" aria-hidden="true"></i></a>
      </li>
      <li>
...
<script>
  ...
  export default {
    ...
    methods: {},
    mounted: function () {
      var chartData = [["2018/01", 50], ["2018/02", 60], ["2018/03", 100], ["2018/04", 200], ["2018/05", 350], ["2018/06", 600]];
